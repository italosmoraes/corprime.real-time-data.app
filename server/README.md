...
- Nest provides a lot of the basic server features, such as auth, so the implementation is a matter of reading, understanding and implemented as per documentation
- A lot of the issues found during development were about basic setup issues that always happen when starting a new project
- using nestjs and nextjs provided an easy way to get the scafolding needed to then go about building on top of it to form the desired application
-
